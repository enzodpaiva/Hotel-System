...
while ($registro = mysqli_fetch_array($result)) {
    ...
    echo "<td> <form action='../deletar/deletFuncionario.php' method='post'>
    ...
    echo "<td> <form action='../atualizar/updateFuncionario.php' method='post'>
					             <input type='hidden' name='id' value=" . $registro['id_funcionario'] . "/>
								<button class='btn btn-success'><span class='glyphicon glyphicon-pencil'></span> atualizar</button></form>
								</td>";
    echo "<td> <form action='../atualizar/updateSenha.php' method='post'>
						             <input type='hidden' name='id' value=" . $registro['id_funcionario'] . "/>
