...
$result = mysqli_query($conn, "SELECT * FROM hospede h LEFT JOIN convenio c on h.convenio_hosp = c.id_convenio WHERE h.sexo_hosp = 'feminino'");
...
while ($registro = mysqli_fetch_array($result)) {
    ...
    echo "<td> <form action='../deletar/deletCliente.php' method='post'>
    ...
    echo "<td> <form action='../atualizar/updateClie.php' method='post'>
					             <input type='hidden' name='id' value=" . $registro['id_hospede'] . "/>
